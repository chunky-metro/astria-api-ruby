...
describe Astria::Client, ".services" do

  subject { described_class.new(base_url: "https://api.astria.test", access_token: "a1b2c3").services }
  ...
  describe "#list_services" do
    ...
    it "builds the correct request" do
      ...
      expect(WebMock).to have_requested(:get, "https://api.astria.test/v2/services")
    ...
    it "supports pagination" do
      ...
      expect(WebMock).to have_requested(:get, "https://api.astria.test/v2/services?page=2")
    end

    it "supports extra request options" do
      subject.services(query: { foo: "bar" })

      expect(WebMock).to have_requested(:get, "https://api.astria.test/v2/services?foo=bar")
    end

    it "supports sorting" do
      subject.services(sort: "short_name:asc")

      expect(WebMock).to have_requested(:get, "https://api.astria.test/v2/services?sort=short_name:asc")
    end
    ...
    it "returns the list of available services" do
      ...
      response.data.each do |service|
        expect(service).to be_a(Astria::Struct::Service)
        ...
        expect(service.settings).to all(be_a(Astria::Struct::Service::Setting))
      end
    end
  end
  ...
  describe "#all_services" do
    ...
    it "supports sorting" do
      ...
      expect(WebMock).to have_requested(:get, "https://api.astria.test/v2/services?page=1&per_page=100&sort=short_name:asc")
    end
  end
  ...
  describe "#service" do
    ...
    it "builds the correct request" do
      ...
      expect(WebMock).to have_requested(:get, "https://api.astria.test/v2/services/#{service_id}")
          .with(headers: { "Accept" => "application/json" })
    end
